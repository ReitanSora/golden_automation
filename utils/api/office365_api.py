...
USERNAME = sharepoint['user_email']
PASSWORD = sharepoint['user_password']
SHAREPOINT_SITE = sharepoint['sharepoint_site']
SHAREPOINT_SITE_NAME = sharepoint['sharepoint_site_name']
SHAREPOINT_DOC = sharepoint['sharepoint_doc_library']
